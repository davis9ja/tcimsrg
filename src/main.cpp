...
int main() {
    ...
    std::cout << "ETA1B 73 " << eta1b[7*numStates+3] << std::endl;
    ...
    state_type y0 = sys.system2vector();
    printf("starting integration\n");

    runge_kutta4<state_type> stepper;
    size_t steps = integrate_n_steps(stepper, sys, y0, 0.0, 0.01, 500, push_back_system(x_vec, times, &sys));
